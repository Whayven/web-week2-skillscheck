...
function oddChecker(num) {
  // 0 in Javascript is falsey, and other integer values are truthy.
  // If this expression evaluates to equal 0, this expression will return false -> "the number is even"
  return num % 2 ? "the number is odd" : "the number is even";
}
...
// Code Here
const enemies = people.filter(el => !el.friend)
